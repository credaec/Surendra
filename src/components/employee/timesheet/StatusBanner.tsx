...
const StatusBanner: React.FC<StatusBannerProps> = ({ status, rejectionReason }) => {
    ...
    if (status === 'DRAFT') {
        return (
            <div className="bg-blue-50/50 border border-blue-100 rounded-lg px-4 py-3 mb-8 flex items-center text-sm text-blue-700">
    ...
    if (status === 'SUBMITTED') {
        return (
            <div className="bg-amber-50 border border-amber-100 rounded-lg px-4 py-3 mb-8 flex items-center text-sm text-amber-800">
    ...
    if (status === 'APPROVED') {
        return (
            <div className="bg-emerald-50 border border-emerald-100 rounded-lg px-4 py-3 mb-8 flex items-center text-sm text-emerald-800">
    ...
    if (status === 'LOCKED') {
        return (
            <div className="bg-slate-100 border border-slate-200 rounded-lg px-4 py-3 mb-8 flex items-center text-sm text-slate-700">
    ...
    if (status === 'REJECTED') {
        return (
            <div className="bg-red-50 border border-red-100 rounded-lg px-4 py-3 mb-8 flex items-start text-sm text-red-800">
                ...
                <div>
                    ...
                    {rejectionReason && <p className="mt-1 text-red-600 font-medium">Reason: "{rejectionReason}"</p>}
                </div>
            </div>
        );
    }
